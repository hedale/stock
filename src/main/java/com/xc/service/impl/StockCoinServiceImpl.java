...
public class StockCoinServiceImpl
  implements IStockCoinService
{
  @Autowired
  ...
  private CoinAdminListVO assembleCoinAdminListVO(StockCoin stockCoin)
  {
    ...
    ServerResponse serverResponse1 = this.iStockFuturesService.getExchangeRate(coinAdminListVO.getCoinCode());
 ...
 * Qualified Name:     com.xc.service.impl.StockCoinServiceImpl
