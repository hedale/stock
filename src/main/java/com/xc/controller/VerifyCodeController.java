...
public class VerifyCodeController
{
  ...
  public ModelAndView getCode(HttpServletRequest request, HttpServletResponse response, @RequestParam(value="timestamp", required=false) String timestamp)
    throws IOException
  {
    ModelAndView mv = new ModelAndView();
 ...
 * Qualified Name:     com.xc.controller.VerifyCodeController
