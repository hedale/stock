...
public class SiteBanner
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$bannerUrl = getBannerUrl();Object other$bannerUrl = other.getBannerUrl();
    if (this$bannerUrl == null ? other$bannerUrl != null : !this$bannerUrl.equals(other$bannerUrl)) {
      return false;
    }
    Object this$isOrder = getIsOrder();Object other$isOrder = other.getIsOrder();
    if (this$isOrder == null ? other$isOrder != null : !this$isOrder.equals(other$isOrder)) {
      return false;
    }
    Object this$isPc = getIsPc();Object other$isPc = other.getIsPc();
    if (this$isPc == null ? other$isPc != null : !this$isPc.equals(other$isPc)) {
      return false;
    }
    Object this$isM = getIsM();Object other$isM = other.getIsM();
    if (this$isM == null ? other$isM != null : !this$isM.equals(other$isM)) {
      return false;
    }
    ...
    Object this$banTitle = getBanTitle();Object other$banTitle = other.getBanTitle();
    if (this$banTitle == null ? other$banTitle != null : !this$banTitle.equals(other$banTitle)) {
      return false;
    }
    Object this$banDesc = getBanDesc();Object other$banDesc = other.getBanDesc();
    if (this$banDesc == null ? other$banDesc != null : !this$banDesc.equals(other$banDesc)) {
      return false;
    }
    Object this$targetUrl = getTargetUrl();Object other$targetUrl = other.getTargetUrl();
 ...
 * Qualified Name:     com.xc.pojo.SiteBanner
