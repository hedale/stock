...
public class SiteSetting
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$buyFee = getBuyFee();Object other$buyFee = other.getBuyFee();
    if (this$buyFee == null ? other$buyFee != null : !this$buyFee.equals(other$buyFee)) {
      return false;
    }
    Object this$sellFee = getSellFee();Object other$sellFee = other.getSellFee();
    if (this$sellFee == null ? other$sellFee != null : !this$sellFee.equals(other$sellFee)) {
      return false;
    }
    Object this$stayFee = getStayFee();Object other$stayFee = other.getStayFee();
    if (this$stayFee == null ? other$stayFee != null : !this$stayFee.equals(other$stayFee)) {
      return false;
    }
    Object this$dutyFee = getDutyFee();Object other$dutyFee = other.getDutyFee();
    if (this$dutyFee == null ? other$dutyFee != null : !this$dutyFee.equals(other$dutyFee)) {
      return false;
    }
    Object this$stayMaxDays = getStayMaxDays();Object other$stayMaxDays = other.getStayMaxDays();
    if (this$stayMaxDays == null ? other$stayMaxDays != null : !this$stayMaxDays.equals(other$stayMaxDays)) {
      return false;
    }
    Object this$buyMinAmt = getBuyMinAmt();Object other$buyMinAmt = other.getBuyMinAmt();
    if (this$buyMinAmt == null ? other$buyMinAmt != null : !this$buyMinAmt.equals(other$buyMinAmt)) {
      return false;
    }
    Object this$chargeMinAmt = getChargeMinAmt();Object other$chargeMinAmt = other.getChargeMinAmt();
    if (this$chargeMinAmt == null ? other$chargeMinAmt != null : !this$chargeMinAmt.equals(other$chargeMinAmt)) {
      return false;
    }
    Object this$buyMinNum = getBuyMinNum();Object other$buyMinNum = other.getBuyMinNum();
    if (this$buyMinNum == null ? other$buyMinNum != null : !this$buyMinNum.equals(other$buyMinNum)) {
      return false;
    }
    Object this$forceStopFee = getForceStopFee();Object other$forceStopFee = other.getForceStopFee();
    if (this$forceStopFee == null ? other$forceStopFee != null : !this$forceStopFee.equals(other$forceStopFee)) {
      return false;
    }
    Object this$buyMaxAmtPercent = getBuyMaxAmtPercent();Object other$buyMaxAmtPercent = other.getBuyMaxAmtPercent();
    if (this$buyMaxAmtPercent == null ? other$buyMaxAmtPercent != null : !this$buyMaxAmtPercent.equals(other$buyMaxAmtPercent)) {
      return false;
    }
    Object this$forceStopPercent = getForceStopPercent();Object other$forceStopPercent = other.getForceStopPercent();
    if (this$forceStopPercent == null ? other$forceStopPercent != null : !this$forceStopPercent.equals(other$forceStopPercent)) {
      return false;
    }
    Object this$hightAndLow = getHightAndLow();Object other$hightAndLow = other.getHightAndLow();
    if (this$hightAndLow == null ? other$hightAndLow != null : !this$hightAndLow.equals(other$hightAndLow)) {
      return false;
    }
    Object this$withMinAmt = getWithMinAmt();Object other$withMinAmt = other.getWithMinAmt();
    if (this$withMinAmt == null ? other$withMinAmt != null : !this$withMinAmt.equals(other$withMinAmt)) {
      return false;
    }
    Object this$creaseMaxPercent = getCreaseMaxPercent();Object other$creaseMaxPercent = other.getCreaseMaxPercent();
    if (this$creaseMaxPercent == null ? other$creaseMaxPercent != null : !this$creaseMaxPercent.equals(other$creaseMaxPercent)) {
      return false;
    }
    Object this$buyMaxNum = getBuyMaxNum();Object other$buyMaxNum = other.getBuyMaxNum();
    if (this$buyMaxNum == null ? other$buyMaxNum != null : !this$buyMaxNum.equals(other$buyMaxNum)) {
      return false;
    }
    Object this$withTimeBegin = getWithTimeBegin();Object other$withTimeBegin = other.getWithTimeBegin();
    if (this$withTimeBegin == null ? other$withTimeBegin != null : !this$withTimeBegin.equals(other$withTimeBegin)) {
      return false;
    }
    Object this$withTimeEnd = getWithTimeEnd();Object other$withTimeEnd = other.getWithTimeEnd();
    ...
    Object this$withFeeSingle = getWithFeeSingle();Object other$withFeeSingle = other.getWithFeeSingle();
    if (this$withFeeSingle == null ? other$withFeeSingle != null : !this$withFeeSingle.equals(other$withFeeSingle)) {
      return false;
    }
    Object this$withFeePercent = getWithFeePercent();Object other$withFeePercent = other.getWithFeePercent();
    if (this$withFeePercent == null ? other$withFeePercent != null : !this$withFeePercent.equals(other$withFeePercent)) {
      return false;
    }
    Object this$siteLever = getSiteLever();Object other$siteLever = other.getSiteLever();
    if (this$siteLever == null ? other$siteLever != null : !this$siteLever.equals(other$siteLever)) {
      return false;
    }
    Object this$buySameTimes = getBuySameTimes();Object other$buySameTimes = other.getBuySameTimes();
    if (this$buySameTimes == null ? other$buySameTimes != null : !this$buySameTimes.equals(other$buySameTimes)) {
      return false;
    }
    Object this$buySameNums = getBuySameNums();Object other$buySameNums = other.getBuySameNums();
    if (this$buySameNums == null ? other$buySameNums != null : !this$buySameNums.equals(other$buySameNums)) {
      return false;
    }
    Object this$buyNumTimes = getBuyNumTimes();Object other$buyNumTimes = other.getBuyNumTimes();
    if (this$buyNumTimes == null ? other$buyNumTimes != null : !this$buyNumTimes.equals(other$buyNumTimes)) {
      return false;
    }
    Object this$buyNumLots = getBuyNumLots();Object other$buyNumLots = other.getBuyNumLots();
    if (this$buyNumLots == null ? other$buyNumLots != null : !this$buyNumLots.equals(other$buyNumLots)) {
      return false;
    }
    Object this$cantSellTimes = getCantSellTimes();Object other$cantSellTimes = other.getCantSellTimes();
    if (this$cantSellTimes == null ? other$cantSellTimes != null : !this$cantSellTimes.equals(other$cantSellTimes)) {
      return false;
    }
    Object this$kcCreaseMaxPercent = getKcCreaseMaxPercent();Object other$kcCreaseMaxPercent = other.getKcCreaseMaxPercent();
    if (this$kcCreaseMaxPercent == null ? other$kcCreaseMaxPercent != null : !this$kcCreaseMaxPercent.equals(other$kcCreaseMaxPercent)) {
      return false;
    }
    Object this$stockDays = getStockDays();Object other$stockDays = other.getStockDays();
    if (this$stockDays == null ? other$stockDays != null : !this$stockDays.equals(other$stockDays)) {
      return false;
    }
    Object this$stockRate = getStockRate();Object other$stockRate = other.getStockRate();
  ...
  {
    return this.cyCreaseMaxPercent;
  }
 ...
 * Qualified Name:     com.xc.pojo.SiteSetting
