...
public class SitePay
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$cType = getCType();Object other$cType = other.getCType();
    if (this$cType == null ? other$cType != null : !this$cType.equals(other$cType)) {
      return false;
    }
    Object this$formUrl = getFormUrl();Object other$formUrl = other.getFormUrl();
    if (this$formUrl == null ? other$formUrl != null : !this$formUrl.equals(other$formUrl)) {
      return false;
    }
    Object this$formCode = getFormCode();Object other$formCode = other.getFormCode();
    if (this$formCode == null ? other$formCode != null : !this$formCode.equals(other$formCode)) {
      return false;
    }
    Object this$channelType = getChannelType();Object other$channelType = other.getChannelType();
    if (this$channelType == null ? other$channelType != null : !this$channelType.equals(other$channelType)) {
      return false;
    }
    Object this$channelName = getChannelName();Object other$channelName = other.getChannelName();
    if (this$channelName == null ? other$channelName != null : !this$channelName.equals(other$channelName)) {
      return false;
    }
    Object this$channelDesc = getChannelDesc();Object other$channelDesc = other.getChannelDesc();
    if (this$channelDesc == null ? other$channelDesc != null : !this$channelDesc.equals(other$channelDesc)) {
      return false;
    }
    Object this$channelAccount = getChannelAccount();Object other$channelAccount = other.getChannelAccount();
    if (this$channelAccount == null ? other$channelAccount != null : !this$channelAccount.equals(other$channelAccount)) {
      return false;
    }
    Object this$channelImg = getChannelImg();Object other$channelImg = other.getChannelImg();
    if (this$channelImg == null ? other$channelImg != null : !this$channelImg.equals(other$channelImg)) {
      return false;
    }
    Object this$channelMinLimit = getChannelMinLimit();Object other$channelMinLimit = other.getChannelMinLimit();
    if (this$channelMinLimit == null ? other$channelMinLimit != null : !this$channelMinLimit.equals(other$channelMinLimit)) {
      return false;
    }
    Object this$channelMaxLimit = getChannelMaxLimit();Object other$channelMaxLimit = other.getChannelMaxLimit();
    if (this$channelMaxLimit == null ? other$channelMaxLimit != null : !this$channelMaxLimit.equals(other$channelMaxLimit)) {
      return false;
    }
    Object this$isShow = getIsShow();Object other$isShow = other.getIsShow();
 ...
 * Qualified Name:     com.xc.pojo.SitePay
