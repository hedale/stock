...
public class SiteInfo
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$siteName = getSiteName();Object other$siteName = other.getSiteName();
    if (this$siteName == null ? other$siteName != null : !this$siteName.equals(other$siteName)) {
      return false;
    }
    Object this$siteHost = getSiteHost();Object other$siteHost = other.getSiteHost();
    if (this$siteHost == null ? other$siteHost != null : !this$siteHost.equals(other$siteHost)) {
      return false;
    }
    Object this$siteKeywords = getSiteKeywords();Object other$siteKeywords = other.getSiteKeywords();
    if (this$siteKeywords == null ? other$siteKeywords != null : !this$siteKeywords.equals(other$siteKeywords)) {
      return false;
    }
    Object this$siteDescription = getSiteDescription();Object other$siteDescription = other.getSiteDescription();
    if (this$siteDescription == null ? other$siteDescription != null : !this$siteDescription.equals(other$siteDescription)) {
      return false;
    }
    Object this$siteLogo = getSiteLogo();Object other$siteLogo = other.getSiteLogo();
    if (this$siteLogo == null ? other$siteLogo != null : !this$siteLogo.equals(other$siteLogo)) {
      return false;
    }
    Object this$siteLogoSm = getSiteLogoSm();Object other$siteLogoSm = other.getSiteLogoSm();
    if (this$siteLogoSm == null ? other$siteLogoSm != null : !this$siteLogoSm.equals(other$siteLogoSm)) {
      return false;
    }
    Object this$siteQq = getSiteQq();Object other$siteQq = other.getSiteQq();
    if (this$siteQq == null ? other$siteQq != null : !this$siteQq.equals(other$siteQq)) {
      return false;
    }
    Object this$sitePhone = getSitePhone();Object other$sitePhone = other.getSitePhone();
    if (this$sitePhone == null ? other$sitePhone != null : !this$sitePhone.equals(other$sitePhone)) {
      return false;
    }
    Object this$siteAndroidImg = getSiteAndroidImg();Object other$siteAndroidImg = other.getSiteAndroidImg();
    if (this$siteAndroidImg == null ? other$siteAndroidImg != null : !this$siteAndroidImg.equals(other$siteAndroidImg)) {
      return false;
    }
    Object this$siteAndroidUrl = getSiteAndroidUrl();Object other$siteAndroidUrl = other.getSiteAndroidUrl();
    if (this$siteAndroidUrl == null ? other$siteAndroidUrl != null : !this$siteAndroidUrl.equals(other$siteAndroidUrl)) {
      return false;
    }
    Object this$siteIosImg = getSiteIosImg();Object other$siteIosImg = other.getSiteIosImg();
    if (this$siteIosImg == null ? other$siteIosImg != null : !this$siteIosImg.equals(other$siteIosImg)) {
      return false;
    }
    Object this$siteIosUrl = getSiteIosUrl();Object other$siteIosUrl = other.getSiteIosUrl();
    if (this$siteIosUrl == null ? other$siteIosUrl != null : !this$siteIosUrl.equals(other$siteIosUrl)) {
      return false;
    }
    Object this$siteEmailFrom = getSiteEmailFrom();Object other$siteEmailFrom = other.getSiteEmailFrom();
    if (this$siteEmailFrom == null ? other$siteEmailFrom != null : !this$siteEmailFrom.equals(other$siteEmailFrom)) {
      return false;
    }
    Object this$siteEmailTo = getSiteEmailTo();Object other$siteEmailTo = other.getSiteEmailTo();
    if (this$siteEmailTo == null ? other$siteEmailTo != null : !this$siteEmailTo.equals(other$siteEmailTo)) {
      return false;
    }
    Object this$siteLanguage = getSiteLanguage();Object other$siteLanguage = other.getSiteLanguage();
    if (this$siteLanguage == null ? other$siteLanguage != null : !this$siteLanguage.equals(other$siteLanguage)) {
      return false;
    }
    Object this$siteVersionInfo = getSiteVersionInfo();Object other$siteVersionInfo = other.getSiteVersionInfo();
    if (this$siteVersionInfo == null ? other$siteVersionInfo != null : !this$siteVersionInfo.equals(other$siteVersionInfo)) {
      return false;
    }
    Object this$siteIntro = getSiteIntro();Object other$siteIntro = other.getSiteIntro();
    if (this$siteIntro == null ? other$siteIntro != null : !this$siteIntro.equals(other$siteIntro)) {
      return false;
    }
    Object this$riskNotice = getRiskNotice();Object other$riskNotice = other.getRiskNotice();
    if (this$riskNotice == null ? other$riskNotice != null : !this$riskNotice.equals(other$riskNotice)) {
      return false;
    }
    Object this$companyInfo = getCompanyInfo();Object other$companyInfo = other.getCompanyInfo();
    if (this$companyInfo == null ? other$companyInfo != null : !this$companyInfo.equals(other$companyInfo)) {
      return false;
    }
    Object this$certImg1 = getCertImg1();Object other$certImg1 = other.getCertImg1();
    if (this$certImg1 == null ? other$certImg1 != null : !this$certImg1.equals(other$certImg1)) {
      return false;
    }
    Object this$certImg2 = getCertImg2();Object other$certImg2 = other.getCertImg2();
    if (this$certImg2 == null ? other$certImg2 != null : !this$certImg2.equals(other$certImg2)) {
      return false;
    }
    Object this$regAgree = getRegAgree();Object other$regAgree = other.getRegAgree();
    if (this$regAgree == null ? other$regAgree != null : !this$regAgree.equals(other$regAgree)) {
      return false;
    }
    Object this$tradeAgree = getTradeAgree();Object other$tradeAgree = other.getTradeAgree();
    if (this$tradeAgree == null ? other$tradeAgree != null : !this$tradeAgree.equals(other$tradeAgree)) {
      return false;
    }
    Object this$siteColor = getSiteColor();Object other$siteColor = other.getSiteColor();
 ...
 * Qualified Name:     com.xc.pojo.SiteInfo
