...
public class User
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$agentName = getAgentName();Object other$agentName = other.getAgentName();
    ...
    Object this$userPwd = getUserPwd();Object other$userPwd = other.getUserPwd();
    if (this$userPwd == null ? other$userPwd != null : !this$userPwd.equals(other$userPwd)) {
      return false;
    }
    Object this$withPwd = getWithPwd();Object other$withPwd = other.getWithPwd();
    if (this$withPwd == null ? other$withPwd != null : !this$withPwd.equals(other$withPwd)) {
      return false;
    }
    ...
    Object this$idCard = getIdCard();Object other$idCard = other.getIdCard();
    if (this$idCard == null ? other$idCard != null : !this$idCard.equals(other$idCard)) {
      return false;
    }
    Object this$accountType = getAccountType();Object other$accountType = other.getAccountType();
    if (this$accountType == null ? other$accountType != null : !this$accountType.equals(other$accountType)) {
      return false;
    }
    Object this$userAmt = getUserAmt();Object other$userAmt = other.getUserAmt();
    if (this$userAmt == null ? other$userAmt != null : !this$userAmt.equals(other$userAmt)) {
      return false;
    }
    Object this$enableAmt = getEnableAmt();Object other$enableAmt = other.getEnableAmt();
    if (this$enableAmt == null ? other$enableAmt != null : !this$enableAmt.equals(other$enableAmt)) {
      return false;
    }
    Object this$sumChargeAmt = getSumChargeAmt();Object other$sumChargeAmt = other.getSumChargeAmt();
    if (this$sumChargeAmt == null ? other$sumChargeAmt != null : !this$sumChargeAmt.equals(other$sumChargeAmt)) {
      return false;
    }
    Object this$sumBuyAmt = getSumBuyAmt();Object other$sumBuyAmt = other.getSumBuyAmt();
    if (this$sumBuyAmt == null ? other$sumBuyAmt != null : !this$sumBuyAmt.equals(other$sumBuyAmt)) {
      return false;
    }
    Object this$recomPhone = getRecomPhone();Object other$recomPhone = other.getRecomPhone();
    ...
    Object this$isLogin = getIsLogin();Object other$isLogin = other.getIsLogin();
    if (this$isLogin == null ? other$isLogin != null : !this$isLogin.equals(other$isLogin)) {
      return false;
    }
    ...
    Object this$regIp = getRegIp();Object other$regIp = other.getRegIp();
    if (this$regIp == null ? other$regIp != null : !this$regIp.equals(other$regIp)) {
      return false;
    }
    Object this$regAddress = getRegAddress();Object other$regAddress = other.getRegAddress();
    if (this$regAddress == null ? other$regAddress != null : !this$regAddress.equals(other$regAddress)) {
      return false;
    }
    Object this$img1Key = getImg1Key();Object other$img1Key = other.getImg1Key();
    if (this$img1Key == null ? other$img1Key != null : !this$img1Key.equals(other$img1Key)) {
      return false;
    }
    Object this$img2Key = getImg2Key();Object other$img2Key = other.getImg2Key();
    if (this$img2Key == null ? other$img2Key != null : !this$img2Key.equals(other$img2Key)) {
      return false;
    }
    Object this$img3Key = getImg3Key();Object other$img3Key = other.getImg3Key();
    if (this$img3Key == null ? other$img3Key != null : !this$img3Key.equals(other$img3Key)) {
      return false;
    }
    Object this$isActive = getIsActive();Object other$isActive = other.getIsActive();
    if (this$isActive == null ? other$isActive != null : !this$isActive.equals(other$isActive)) {
      return false;
    }
    Object this$authMsg = getAuthMsg();Object other$authMsg = other.getAuthMsg();
    if (this$authMsg == null ? other$authMsg != null : !this$authMsg.equals(other$authMsg)) {
      return false;
    }
    Object this$userIndexAmt = getUserIndexAmt();Object other$userIndexAmt = other.getUserIndexAmt();
    if (this$userIndexAmt == null ? other$userIndexAmt != null : !this$userIndexAmt.equals(other$userIndexAmt)) {
      return false;
    }
    Object this$enableIndexAmt = getEnableIndexAmt();Object other$enableIndexAmt = other.getEnableIndexAmt();
    if (this$enableIndexAmt == null ? other$enableIndexAmt != null : !this$enableIndexAmt.equals(other$enableIndexAmt)) {
      return false;
    }
    Object this$userFutAmt = getUserFutAmt();Object other$userFutAmt = other.getUserFutAmt();
    if (this$userFutAmt == null ? other$userFutAmt != null : !this$userFutAmt.equals(other$userFutAmt)) {
      return false;
    }
    Object this$enableFutAmt = getEnableFutAmt();Object other$enableFutAmt = other.getEnableFutAmt();
    if (this$enableFutAmt == null ? other$enableFutAmt != null : !this$enableFutAmt.equals(other$enableFutAmt)) {
      return false;
    }
    Object this$withdrawalPwd = getWithdrawalPwd();Object other$withdrawalPwd = other.getWithdrawalPwd();
 ...
 * Qualified Name:     com.xc.pojo.User
