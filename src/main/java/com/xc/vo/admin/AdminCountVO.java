...
public class AdminCountVO
{
  ...
  public boolean equals(Object o)
  {
    ...
    if (getUser_sp_num() != other.getUser_sp_num()) {
      return false;
    }
    if (getUser_moni_num() != other.getUser_moni_num()) {
      return false;
    }
    if (getAgent_num() != other.getAgent_num()) {
      return false;
    }
    Object this$user_sp_sum_amt = getUser_sp_sum_amt();Object other$user_sp_sum_amt = other.getUser_sp_sum_amt();
    if (this$user_sp_sum_amt == null ? other$user_sp_sum_amt != null : !this$user_sp_sum_amt.equals(other$user_sp_sum_amt)) {
      return false;
    }
    Object this$user_sp_sum_enable = getUser_sp_sum_enable();Object other$user_sp_sum_enable = other.getUser_sp_sum_enable();
    if (this$user_sp_sum_enable == null ? other$user_sp_sum_enable != null : !this$user_sp_sum_enable.equals(other$user_sp_sum_enable)) {
      return false;
    }
    Object this$charge_sum_amt = getCharge_sum_amt();Object other$charge_sum_amt = other.getCharge_sum_amt();
    if (this$charge_sum_amt == null ? other$charge_sum_amt != null : !this$charge_sum_amt.equals(other$charge_sum_amt)) {
      return false;
    }
    Object this$sp_withdraw_sum_amt_success = getSp_withdraw_sum_amt_success();Object other$sp_withdraw_sum_amt_success = other.getSp_withdraw_sum_amt_success();
    ...
    Object this$sp_withdraw_sum_amt_apply = getSp_withdraw_sum_amt_apply();Object other$sp_withdraw_sum_amt_apply = other.getSp_withdraw_sum_amt_apply();
    ...
    if (getSp_position_num() != other.getSp_position_num()) {
      return false;
    }
    if (getSp_pc_position_num() != other.getSp_pc_position_num()) {
      return false;
    }
    Object this$sp_profit_and_lose = getSp_profit_and_lose();Object other$sp_profit_and_lose = other.getSp_profit_and_lose();
    if (this$sp_profit_and_lose == null ? other$sp_profit_and_lose != null : !this$sp_profit_and_lose.equals(other$sp_profit_and_lose)) {
      return false;
    }
    Object this$sp_all_profit_and_lose = getSp_all_profit_and_lose();Object other$sp_all_profit_and_lose = other.getSp_all_profit_and_lose();
    return this$sp_all_profit_and_lose == null ? other$sp_all_profit_and_lose == null : this$sp_all_profit_and_lose.equals(other$sp_all_profit_and_lose);
  }
  ...
  {
    return this.sp_withdraw_sum_today_amt_success;
  }
  ...
  {
    return this.charge_today_sum_amt;
  }
 ...
 * Qualified Name:     com.xc.vo.admin.AdminCountVO
