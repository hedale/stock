...
public class GuoPayVO
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$postUrl = getPostUrl();Object other$postUrl = other.getPostUrl();
    if (this$postUrl == null ? other$postUrl != null : !this$postUrl.equals(other$postUrl)) {
      return false;
    }
    Object this$pay_memberid = getPay_memberid();Object other$pay_memberid = other.getPay_memberid();
    if (this$pay_memberid == null ? other$pay_memberid != null : !this$pay_memberid.equals(other$pay_memberid)) {
      return false;
    }
    Object this$pay_orderid = getPay_orderid();Object other$pay_orderid = other.getPay_orderid();
    if (this$pay_orderid == null ? other$pay_orderid != null : !this$pay_orderid.equals(other$pay_orderid)) {
      return false;
    }
    Object this$pay_applydate = getPay_applydate();Object other$pay_applydate = other.getPay_applydate();
    if (this$pay_applydate == null ? other$pay_applydate != null : !this$pay_applydate.equals(other$pay_applydate)) {
      return false;
    }
    Object this$pay_bankcode = getPay_bankcode();Object other$pay_bankcode = other.getPay_bankcode();
    if (this$pay_bankcode == null ? other$pay_bankcode != null : !this$pay_bankcode.equals(other$pay_bankcode)) {
      return false;
    }
    Object this$pay_notifyurl = getPay_notifyurl();Object other$pay_notifyurl = other.getPay_notifyurl();
    if (this$pay_notifyurl == null ? other$pay_notifyurl != null : !this$pay_notifyurl.equals(other$pay_notifyurl)) {
      return false;
    }
    Object this$pay_callbackurl = getPay_callbackurl();Object other$pay_callbackurl = other.getPay_callbackurl();
    if (this$pay_callbackurl == null ? other$pay_callbackurl != null : !this$pay_callbackurl.equals(other$pay_callbackurl)) {
      return false;
    }
    Object this$pay_amount = getPay_amount();Object other$pay_amount = other.getPay_amount();
    if (this$pay_amount == null ? other$pay_amount != null : !this$pay_amount.equals(other$pay_amount)) {
      return false;
    }
    Object this$pay_productname = getPay_productname();Object other$pay_productname = other.getPay_productname();
    if (this$pay_productname == null ? other$pay_productname != null : !this$pay_productname.equals(other$pay_productname)) {
      return false;
    }
    Object this$pay_productnum = getPay_productnum();Object other$pay_productnum = other.getPay_productnum();
    if (this$pay_productnum == null ? other$pay_productnum != null : !this$pay_productnum.equals(other$pay_productnum)) {
      return false;
    }
    Object this$pay_productdesc = getPay_productdesc();Object other$pay_productdesc = other.getPay_productdesc();
    if (this$pay_productdesc == null ? other$pay_productdesc != null : !this$pay_productdesc.equals(other$pay_productdesc)) {
      return false;
    }
    Object this$pay_producturl = getPay_producturl();Object other$pay_producturl = other.getPay_producturl();
    if (this$pay_producturl == null ? other$pay_producturl != null : !this$pay_producturl.equals(other$pay_producturl)) {
      return false;
    }
    Object this$pay_md5sign = getPay_md5sign();Object other$pay_md5sign = other.getPay_md5sign();
 ...
 * Qualified Name:     com.xc.vo.pay.GuoPayVO
