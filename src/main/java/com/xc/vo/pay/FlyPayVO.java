...
public class FlyPayVO
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$payUrl = getPayUrl();Object other$payUrl = other.getPayUrl();
    if (this$payUrl == null ? other$payUrl != null : !this$payUrl.equals(other$payUrl)) {
      return false;
    }
    Object this$merchantid = getMerchantid();Object other$merchantid = other.getMerchantid();
    if (this$merchantid == null ? other$merchantid != null : !this$merchantid.equals(other$merchantid)) {
      return false;
    }
    Object this$orderno = getOrderno();Object other$orderno = other.getOrderno();
    if (this$orderno == null ? other$orderno != null : !this$orderno.equals(other$orderno)) {
      return false;
    }
    Object this$orderamount = getOrderamount();Object other$orderamount = other.getOrderamount();
    ...
    Object this$ordercurrency = getOrdercurrency();Object other$ordercurrency = other.getOrdercurrency();
    if (this$ordercurrency == null ? other$ordercurrency != null : !this$ordercurrency.equals(other$ordercurrency)) {
      return false;
    }
    Object this$serverbackurl = getServerbackurl();Object other$serverbackurl = other.getServerbackurl();
    if (this$serverbackurl == null ? other$serverbackurl != null : !this$serverbackurl.equals(other$serverbackurl)) {
      return false;
    }
    Object this$callbackurl = getCallbackurl();Object other$callbackurl = other.getCallbackurl();
    if (this$callbackurl == null ? other$callbackurl != null : !this$callbackurl.equals(other$callbackurl)) {
      return false;
    }
    Object this$signtype = getSigntype();Object other$signtype = other.getSigntype();
    if (this$signtype == null ? other$signtype != null : !this$signtype.equals(other$signtype)) {
      return false;
    }
    Object this$sign = getSign();Object other$sign = other.getSign();
 ...
 * Qualified Name:     com.xc.vo.pay.FlyPayVO
