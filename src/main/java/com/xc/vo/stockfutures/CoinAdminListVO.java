...
public class CoinAdminListVO
{
  ...
  public boolean equals(Object o)
  {
    ...
    if (!(o instanceof CoinAdminListVO)) {
      return false;
    }
    ...
    Object this$coinName = getCoinName();Object other$coinName = other.getCoinName();
    if (this$coinName == null ? other$coinName != null : !this$coinName.equals(other$coinName)) {
      return false;
    }
    ...
    Object this$coinGid = getCoinGid();Object other$coinGid = other.getCoinGid();
    if (this$coinGid == null ? other$coinGid != null : !this$coinGid.equals(other$coinGid)) {
      return false;
    }
    Object this$dynamicRate = getDynamicRate();Object other$dynamicRate = other.getDynamicRate();
    if (this$dynamicRate == null ? other$dynamicRate != null : !this$dynamicRate.equals(other$dynamicRate)) {
      return false;
    }
    Object this$defaultRate = getDefaultRate();Object other$defaultRate = other.getDefaultRate();
    if (this$defaultRate == null ? other$defaultRate != null : !this$defaultRate.equals(other$defaultRate)) {
      return false;
    }
    Object this$isUse = getIsUse();Object other$isUse = other.getIsUse();
    if (this$isUse == null ? other$isUse != null : !this$isUse.equals(other$isUse)) {
      return false;
    }
 ...
 * Qualified Name:     com.xc.vo.stockfutures.CoinAdminListVO
