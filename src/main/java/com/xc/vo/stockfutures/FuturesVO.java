...
public class FuturesVO
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$lastClose = getLastClose();Object other$lastClose = other.getLastClose();
    if (this$lastClose == null ? other$lastClose != null : !this$lastClose.equals(other$lastClose)) {
      return false;
    }
    Object this$buyPrice = getBuyPrice();Object other$buyPrice = other.getBuyPrice();
    if (this$buyPrice == null ? other$buyPrice != null : !this$buyPrice.equals(other$buyPrice)) {
      return false;
    }
    Object this$sellPrice = getSellPrice();Object other$sellPrice = other.getSellPrice();
    if (this$sellPrice == null ? other$sellPrice != null : !this$sellPrice.equals(other$sellPrice)) {
      return false;
    }
    Object this$maxPrice = getMaxPrice();Object other$maxPrice = other.getMaxPrice();
    if (this$maxPrice == null ? other$maxPrice != null : !this$maxPrice.equals(other$maxPrice)) {
      return false;
    }
    Object this$minPrice = getMinPrice();Object other$minPrice = other.getMinPrice();
    if (this$minPrice == null ? other$minPrice != null : !this$minPrice.equals(other$minPrice)) {
      return false;
    }
    Object this$hourTime = getHourTime();Object other$hourTime = other.getHourTime();
    if (this$hourTime == null ? other$hourTime != null : !this$hourTime.equals(other$hourTime)) {
      return false;
    }
    Object this$todayOpen = getTodayOpen();Object other$todayOpen = other.getTodayOpen();
    if (this$todayOpen == null ? other$todayOpen != null : !this$todayOpen.equals(other$todayOpen)) {
      return false;
    }
    Object this$extra1 = getExtra1();Object other$extra1 = other.getExtra1();
    if (this$extra1 == null ? other$extra1 != null : !this$extra1.equals(other$extra1)) {
      return false;
    }
    Object this$extra2 = getExtra2();Object other$extra2 = other.getExtra2();
    if (this$extra2 == null ? other$extra2 != null : !this$extra2.equals(other$extra2)) {
      return false;
    }
    Object this$extra3 = getExtra3();Object other$extra3 = other.getExtra3();
    if (this$extra3 == null ? other$extra3 != null : !this$extra3.equals(other$extra3)) {
      return false;
    }
    Object this$dayTime = getDayTime();Object other$dayTime = other.getDayTime();
    if (this$dayTime == null ? other$dayTime != null : !this$dayTime.equals(other$dayTime)) {
      return false;
    }
 ...
 * Qualified Name:     com.xc.vo.stockfutures.FuturesVO
