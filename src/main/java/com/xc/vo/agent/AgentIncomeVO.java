...
public class AgentIncomeVO
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$orderSize = getOrderSize();Object other$orderSize = other.getOrderSize();
    if (this$orderSize == null ? other$orderSize != null : !this$orderSize.equals(other$orderSize)) {
      return false;
    }
    Object this$orderFeeAmt = getOrderFeeAmt();Object other$orderFeeAmt = other.getOrderFeeAmt();
    if (this$orderFeeAmt == null ? other$orderFeeAmt != null : !this$orderFeeAmt.equals(other$orderFeeAmt)) {
      return false;
    }
    Object this$orderProfitAndLose = getOrderProfitAndLose();Object other$orderProfitAndLose = other.getOrderProfitAndLose();
    if (this$orderProfitAndLose == null ? other$orderProfitAndLose != null : !this$orderProfitAndLose.equals(other$orderProfitAndLose)) {
      return false;
    }
    Object this$orderAllAmt = getOrderAllAmt();Object other$orderAllAmt = other.getOrderAllAmt();
 ...
 * Qualified Name:     com.xc.vo.agent.AgentIncomeVO
