...
public class AgentInfoVO
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$agentRealName = getAgentRealName();Object other$agentRealName = other.getAgentRealName();
    if (this$agentRealName == null ? other$agentRealName != null : !this$agentRealName.equals(other$agentRealName)) {
      return false;
    }
    Object this$agentPhone = getAgentPhone();Object other$agentPhone = other.getAgentPhone();
    if (this$agentPhone == null ? other$agentPhone != null : !this$agentPhone.equals(other$agentPhone)) {
      return false;
    }
    Object this$agentCode = getAgentCode();Object other$agentCode = other.getAgentCode();
    ...
    Object this$parentId = getParentId();Object other$parentId = other.getParentId();
    if (this$parentId == null ? other$parentId != null : !this$parentId.equals(other$parentId)) {
      return false;
    }
    Object this$parentName = getParentName();Object other$parentName = other.getParentName();
    if (this$parentName == null ? other$parentName != null : !this$parentName.equals(other$parentName)) {
      return false;
    }
    Object this$mUrl = getMUrl();Object other$mUrl = other.getMUrl();
    if (this$mUrl == null ? other$mUrl != null : !this$mUrl.equals(other$mUrl)) {
      return false;
    }
    Object this$pcUrl = getPcUrl();Object other$pcUrl = other.getPcUrl();
 ...
 * Qualified Name:     com.xc.vo.agent.AgentInfoVO
