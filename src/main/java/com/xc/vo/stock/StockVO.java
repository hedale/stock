...
public class StockVO
{
  ...
  public boolean equals(Object o)
  {
    ...
    Object this$spell = getSpell();Object other$spell = other.getSpell();
    if (this$spell == null ? other$spell != null : !this$spell.equals(other$spell)) {
      return false;
    }
    Object this$gid = getGid();Object other$gid = other.getGid();
    ...
    Object this$hcrate = getHcrate();Object other$hcrate = other.getHcrate();
    if (this$hcrate == null ? other$hcrate != null : !this$hcrate.equals(other$hcrate)) {
      return false;
    }
    Object this$today_max = getToday_max();Object other$today_max = other.getToday_max();
    if (this$today_max == null ? other$today_max != null : !this$today_max.equals(other$today_max)) {
      return false;
    }
    Object this$today_min = getToday_min();Object other$today_min = other.getToday_min();
    if (this$today_min == null ? other$today_min != null : !this$today_min.equals(other$today_min)) {
      return false;
    }
    Object this$business_balance = getBusiness_balance();Object other$business_balance = other.getBusiness_balance();
    if (this$business_balance == null ? other$business_balance != null : !this$business_balance.equals(other$business_balance)) {
      return false;
    }
    Object this$business_amount = getBusiness_amount();Object other$business_amount = other.getBusiness_amount();
    if (this$business_amount == null ? other$business_amount != null : !this$business_amount.equals(other$business_amount)) {
      return false;
    }
    Object this$preclose_px = getPreclose_px();Object other$preclose_px = other.getPreclose_px();
    if (this$preclose_px == null ? other$preclose_px != null : !this$preclose_px.equals(other$preclose_px)) {
      return false;
    }
    Object this$open_px = getOpen_px();Object other$open_px = other.getOpen_px();
    if (this$open_px == null ? other$open_px != null : !this$open_px.equals(other$open_px)) {
      return false;
    }
    Object this$buy1 = getBuy1();Object other$buy1 = other.getBuy1();
    if (this$buy1 == null ? other$buy1 != null : !this$buy1.equals(other$buy1)) {
      return false;
    }
    Object this$buy2 = getBuy2();Object other$buy2 = other.getBuy2();
    if (this$buy2 == null ? other$buy2 != null : !this$buy2.equals(other$buy2)) {
      return false;
    }
    Object this$buy3 = getBuy3();Object other$buy3 = other.getBuy3();
    if (this$buy3 == null ? other$buy3 != null : !this$buy3.equals(other$buy3)) {
      return false;
    }
    Object this$buy4 = getBuy4();Object other$buy4 = other.getBuy4();
    if (this$buy4 == null ? other$buy4 != null : !this$buy4.equals(other$buy4)) {
      return false;
    }
    Object this$buy5 = getBuy5();Object other$buy5 = other.getBuy5();
    if (this$buy5 == null ? other$buy5 != null : !this$buy5.equals(other$buy5)) {
      return false;
    }
    Object this$sell1 = getSell1();Object other$sell1 = other.getSell1();
    if (this$sell1 == null ? other$sell1 != null : !this$sell1.equals(other$sell1)) {
      return false;
    }
    Object this$sell2 = getSell2();Object other$sell2 = other.getSell2();
    if (this$sell2 == null ? other$sell2 != null : !this$sell2.equals(other$sell2)) {
      return false;
    }
    Object this$sell3 = getSell3();Object other$sell3 = other.getSell3();
    if (this$sell3 == null ? other$sell3 != null : !this$sell3.equals(other$sell3)) {
      return false;
    }
    Object this$sell4 = getSell4();Object other$sell4 = other.getSell4();
    if (this$sell4 == null ? other$sell4 != null : !this$sell4.equals(other$sell4)) {
      return false;
    }
    Object this$sell5 = getSell5();Object other$sell5 = other.getSell5();
    if (this$sell5 == null ? other$sell5 != null : !this$sell5.equals(other$sell5)) {
      return false;
    }
    Object this$buy1_num = getBuy1_num();Object other$buy1_num = other.getBuy1_num();
    if (this$buy1_num == null ? other$buy1_num != null : !this$buy1_num.equals(other$buy1_num)) {
      return false;
    }
    Object this$buy2_num = getBuy2_num();Object other$buy2_num = other.getBuy2_num();
    if (this$buy2_num == null ? other$buy2_num != null : !this$buy2_num.equals(other$buy2_num)) {
      return false;
    }
    Object this$buy3_num = getBuy3_num();Object other$buy3_num = other.getBuy3_num();
    if (this$buy3_num == null ? other$buy3_num != null : !this$buy3_num.equals(other$buy3_num)) {
      return false;
    }
    Object this$buy4_num = getBuy4_num();Object other$buy4_num = other.getBuy4_num();
    if (this$buy4_num == null ? other$buy4_num != null : !this$buy4_num.equals(other$buy4_num)) {
      return false;
    }
    Object this$buy5_num = getBuy5_num();Object other$buy5_num = other.getBuy5_num();
    if (this$buy5_num == null ? other$buy5_num != null : !this$buy5_num.equals(other$buy5_num)) {
      return false;
    }
    Object this$sell1_num = getSell1_num();Object other$sell1_num = other.getSell1_num();
    if (this$sell1_num == null ? other$sell1_num != null : !this$sell1_num.equals(other$sell1_num)) {
      return false;
    }
    Object this$sell2_num = getSell2_num();Object other$sell2_num = other.getSell2_num();
    if (this$sell2_num == null ? other$sell2_num != null : !this$sell2_num.equals(other$sell2_num)) {
      return false;
    }
    Object this$sell3_num = getSell3_num();Object other$sell3_num = other.getSell3_num();
    if (this$sell3_num == null ? other$sell3_num != null : !this$sell3_num.equals(other$sell3_num)) {
      return false;
    }
    Object this$sell4_num = getSell4_num();Object other$sell4_num = other.getSell4_num();
    if (this$sell4_num == null ? other$sell4_num != null : !this$sell4_num.equals(other$sell4_num)) {
      return false;
    }
    Object this$sell5_num = getSell5_num();Object other$sell5_num = other.getSell5_num();
    if (this$sell5_num == null ? other$sell5_num != null : !this$sell5_num.equals(other$sell5_num)) {
      return false;
    }
    Object this$minImg = getMinImg();Object other$minImg = other.getMinImg();
    if (this$minImg == null ? other$minImg != null : !this$minImg.equals(other$minImg)) {
      return false;
    }
    Object this$dayImg = getDayImg();Object other$dayImg = other.getDayImg();
    if (this$dayImg == null ? other$dayImg != null : !this$dayImg.equals(other$dayImg)) {
      return false;
    }
    Object this$weekImg = getWeekImg();Object other$weekImg = other.getWeekImg();
    if (this$weekImg == null ? other$weekImg != null : !this$weekImg.equals(other$weekImg)) {
      return false;
    }
    Object this$monthImg = getMonthImg();Object other$monthImg = other.getMonthImg();
 ...
 * Qualified Name:     com.xc.vo.stock.StockVO
