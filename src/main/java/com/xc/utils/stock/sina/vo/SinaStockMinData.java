package com.xc.utils.stock.sina.vo;
...
public class SinaStockMinData
{
  ...
  public boolean equals(Object o)
  {
    ...
    if (!(o instanceof SinaStockMinData)) {
      return false;
    }
    ...
    Object this$day = getDay();Object other$day = other.getDay();
    if (this$day == null ? other$day != null : !this$day.equals(other$day)) {
      return false;
    }
    Object this$open = getOpen();Object other$open = other.getOpen();
    if (this$open == null ? other$open != null : !this$open.equals(other$open)) {
      return false;
    }
    Object this$high = getHigh();Object other$high = other.getHigh();
    if (this$high == null ? other$high != null : !this$high.equals(other$high)) {
      return false;
    }
    Object this$low = getLow();Object other$low = other.getLow();
    if (this$low == null ? other$low != null : !this$low.equals(other$low)) {
      return false;
    }
    Object this$close = getClose();Object other$close = other.getClose();
    if (this$close == null ? other$close != null : !this$close.equals(other$close)) {
      return false;
    }
    Object this$volume = getVolume();Object other$volume = other.getVolume();
 ...
 * Qualified Name:     com.xc.utils.stock.sina.vo.SinaStockMinData
